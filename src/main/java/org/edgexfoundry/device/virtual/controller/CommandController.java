...
import org.edgexfoundry.device.virtual.handler.CommandHandler;
...
public class CommandController {
	...
	@RequestMapping(value = "/{deviceId}/{cmd}", method = RequestMethod.GET)
	public Callable<Map<String,String>> getCommand(@PathVariable String deviceId, @PathVariable String cmd) {
		Callable<Map<String,String>> callable = new Callable<Map<String,String>>() {
			...
			public Map<String,String> call() throws Exception {
				return command.getResponse(deviceId, cmd, null);
			}
		};
		return callable;
	}
	
	@RequestMapping(value = "/{deviceId}/{cmd}", method = { RequestMethod.PUT, RequestMethod.POST })
	public Callable<Map<String,String>> putCommand(@PathVariable String deviceId, @PathVariable String cmd,
