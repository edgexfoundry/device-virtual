...
public class ProfileStore {
	...
	// profile
	// object key
	private Map<String, Map<String, VirtualObject>> objects = new HashMap<>();
	
	public Map<String, Map<String, VirtualObject>> getObjects() {
		return objects;
	}
	...
	public void addDevice(Device device) {
		...
		Map<String, VirtualObject> deviceObjects = new HashMap<>();
		for (DeviceObject object: device.getProfile().getDeviceResources()) {
			VirtualObject VirtualObject = new VirtualObject(object);
			
			PropertyValue value = object.getProperties().getValue();
			
			deviceObjects.put(object.getName(), VirtualObject);
